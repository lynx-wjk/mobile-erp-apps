-- CLEANUP_UNUSED_FUNCTIONS_AFTER_PASS.sql
...
-- the active Patch40 source scan after fallback cleanup.
...
-- ---------------------------------------------------------------------------
drop function if exists public.finance_sku_summary_rows_v24_6_80m(p_start date, p_end date, p_marketplace text, p_account_id uuid);
drop function if exists public.finance_sku_summary_rows_v24_6_82(p_start date, p_end date, p_marketplace text, p_account_id uuid);
drop function if exists public.finance_sku_summary_rows_v24_6_82b(p_start date, p_end date, p_marketplace text, p_account_id uuid);
drop function if exists public.finance_sku_summary_rows_v24_6_82c(p_start date, p_end date, p_marketplace text, p_account_id uuid);
...
drop function if exists public.finance_sku_order_details_v24_6_80l(p_start date, p_end date, p_marketplace text, p_account_id uuid);
drop function if exists public.finance_sku_order_details_v24_6_80m(p_start date, p_end date, p_marketplace text, p_account_id uuid);
drop function if exists public.finance_sku_order_detail_lines_v24_6_80m(p_start date, p_end date, p_marketplace text, p_account_id uuid, p_sku text, p_limit integer);
drop function if exists public.finance_sku_order_detail_lines_v24_6_82(p_start date, p_end date, p_marketplace text, p_account_id uuid, p_sku text, p_limit integer, p_offset integer);
drop function if exists public.finance_sku_order_detail_lines_v24_6_82b(p_start date, p_end date, p_marketplace text, p_account_id uuid, p_sku text, p_limit integer, p_offset integer);
...
drop function if exists public.finance_unpaid_sku_rows_v24_6_79(p_start date, p_end date, p_marketplace text, p_account_id uuid);
drop function if exists public.finance_unpaid_sku_rows_v24_6_80(p_start date, p_end date, p_marketplace text, p_account_id uuid);
drop function if exists public.finance_unpaid_sku_rows_v24_6_80b(p_start date, p_end date, p_marketplace text, p_account_id uuid);
...
drop function if exists public.finance_unpaid_sku_rows_v24_6_80g(p_start date, p_end date, p_marketplace text, p_account_id uuid);
drop function if exists public.finance_unpaid_sku_rows_v24_6_80h(p_start date, p_end date, p_marketplace text, p_account_id uuid);
drop function if exists public.finance_unpaid_sku_rows_v24_6_80i(p_start date, p_end date, p_marketplace text, p_account_id uuid);
drop function if exists public.finance_unpaid_sku_rows_v24_6_80j(p_start date, p_end date, p_marketplace text, p_account_id uuid);
drop function if exists public.finance_unpaid_sku_rows_v24_6_82(p_start date, p_end date, p_marketplace text, p_account_id uuid);
drop function if exists public.finance_unpaid_sku_rows_v24_6_82b(p_start date, p_end date, p_marketplace text, p_account_id uuid);

drop function if exists public.finance_anomaly_search_v24_6_28(p_start date, p_end date, p_marketplace text, p_account_id uuid, p_search text, p_status text, p_page integer, p_page_size integer);
...
drop function if exists public.finance_anomaly_search_v24_6_31(p_start date, p_end date, p_marketplace text, p_account_id uuid, p_search text, p_status text, p_page integer, p_page_size integer);
drop function if exists public.finance_anomaly_search_v24_6_41(p_start date, p_end date, p_marketplace text, p_account_id uuid, p_search text, p_status text, p_page integer, p_page_size integer);
...
drop function if exists public.finance_anomaly_search_v24_6_55(p_start date, p_end date, p_marketplace text, p_account_id uuid, p_search text, p_status text, p_page integer, p_page_size integer);
drop function if exists public.finance_anomaly_search_v24_6_56(p_start date, p_end date, p_marketplace text, p_account_id uuid, p_search text, p_status text, p_page integer, p_page_size integer);
drop function if exists public.finance_anomaly_search_v24_6_57(p_start date, p_end date, p_marketplace text, p_account_id uuid, p_search text, p_status text, p_page integer, p_page_size integer);
drop function if exists public.finance_anomaly_search_v24_6_58(p_start date, p_end date, p_marketplace text, p_account_id uuid, p_search text, p_status text, p_page integer, p_page_size integer);
...
drop function if exists public.finance_anomaly_search_v24_6_78(p_start date, p_end date, p_marketplace text, p_account_id uuid, p_search text, p_status text, p_page integer, p_page_size integer);
drop function if exists public.finance_anomaly_search_v24_6_79(p_start date, p_end date, p_marketplace text, p_account_id uuid, p_search text, p_status text, p_page integer, p_page_size integer);
drop function if exists public.finance_anomaly_search_v24_6_80(p_start date, p_end date, p_marketplace text, p_account_id uuid, p_search text, p_status text, p_page integer, p_page_size integer);
drop function if exists public.finance_anomaly_search_v24_6_80b(p_start date, p_end date, p_marketplace text, p_account_id uuid, p_search text, p_status text, p_page integer, p_page_size integer);
drop function if exists public.finance_anomaly_search_v24_6_80c(p_start date, p_end date, p_marketplace text, p_account_id uuid, p_search text, p_status text, p_page integer, p_page_size integer);
...
drop function if exists public.finance_anomaly_search_v24_6_80e(p_start date, p_end date, p_marketplace text, p_account_id uuid, p_search text, p_status text, p_page integer, p_page_size integer);
...
drop function if exists public.finance_anomaly_search_v24_6_80g(p_start date, p_end date, p_marketplace text, p_account_id uuid, p_search text, p_status text, p_page integer, p_page_size integer);
...
drop function if exists public.finance_anomaly_search_v24_6_80i(p_start date, p_end date, p_marketplace text, p_account_id uuid, p_search text, p_status text, p_page integer, p_page_size integer);
drop function if exists public.finance_anomaly_search_v24_6_80j(p_start date, p_end date, p_marketplace text, p_account_id uuid, p_search text, p_status text, p_page integer, p_page_size integer);
...
drop function if exists public.finance_anomaly_search_v24_6_80l(p_start date, p_end date, p_marketplace text, p_account_id uuid, p_search text, p_status text, p_page integer, p_page_size integer);
drop function if exists public.finance_anomaly_search_v24_6_80m(p_start date, p_end date, p_marketplace text, p_account_id uuid, p_search text, p_status text, p_page integer, p_page_size integer);
...
drop function if exists public.finance_insert_manual_operational_expense_v24_6_29(p_expense_date date, p_category text, p_amount numeric, p_note text);
...
drop function if exists public.finance_insert_manual_operational_expense_v24_6_78(p_category text, p_amount numeric, p_expense_date date, p_note text);
drop function if exists public.finance_list_manual_operational_expenses_v24_6_77(p_start date, p_end date);
drop function if exists public.finance_list_manual_operational_expenses_v24_6_78(p_start date, p_end date, p_marketplace text, p_account_id uuid);
drop function if exists public.finance_list_manual_operational_expenses_v24_6_79(p_start date, p_end date, p_marketplace text, p_account_id uuid);
drop function if exists public.finance_update_manual_operational_expense(p_expense_id uuid, p_amount numeric, p_category text, p_expense_date date, p_note text);
drop function if exists public.finance_update_manual_operational_expense(p_expense_id uuid, p_category text, p_amount numeric, p_expense_date date, p_note text);
drop function if exists public.finance_update_manual_operational_expense_v24_6_78(p_expense_id uuid, p_category text, p_amount numeric, p_expense_date date, p_note text);
drop function if exists public.finance_delete_manual_operational_expense(p_expense_id uuid);
drop function if exists public.finance_delete_manual_operational_expense_v24_6_78(p_expense_id uuid);
...
drop function if exists public.marketplace_refund_cancel_review_v24_6_36(p_account_id uuid, p_search text, p_page integer, p_page_size integer);
drop function if exists public.marketplace_refund_cancel_review_v24_6_36(p_start date, p_end date, p_marketplace text, p_account_id uuid, p_search text, p_action text, p_page integer, p_page_size integer);
drop function if exists public.marketplace_refund_cancel_review_v24_6_39(p_start date, p_end date, p_marketplace text, p_account_id uuid, p_search text, p_action text, p_page integer, p_page_size integer);
drop function if exists public.marketplace_refund_cancel_review_v24_6_41(p_start date, p_end date, p_marketplace text, p_account_id uuid, p_search text, p_action text, p_page integer, p_page_size integer);
