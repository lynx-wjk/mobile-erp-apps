...
async def main():
    async with async_playwright() as p:
        ...
        # Click Tab Biaya (x=355, y=86)
        print("Clicking Tab Biaya via coordinates (x=355, y=86)...")
        await page.mouse.click(355, 86)
        await page.wait_for_timeout(5000)

        s2 = os.path.join(out_dir, "v48_verified_biaya_tab_exact_v3.png")
