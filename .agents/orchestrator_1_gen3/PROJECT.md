...
- **Frontend**: Flutter Web/Mobile app (`lib/features/finance/presentation/finance_report_page.dart`).
...
| 2 | Flutter UI Alignment | Update `lib/features/finance/presentation/finance_report_page.dart` for retur modal & count map | M1 | DONE |
| 3 | E2E Acceptance Verification | Test queries on June & July 2026 datasets and widget/integration verification | M1, M2 | DONE |
| 4 | Web Release & VPS Deploy | `flutter build web --release` and deploy to `https://mdhproduction.com` | M1, M2, M3 | DONE |
