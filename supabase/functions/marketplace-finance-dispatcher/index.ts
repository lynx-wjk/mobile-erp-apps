...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const windowDays = clampInt(body.window_days, 1, 180, 90);
    const bootstrapDays = clampInt(body.bootstrap_days, 1, 180, 90);
    const maxOrders = clampInt(body.max_orders, 1, 500, 150);
