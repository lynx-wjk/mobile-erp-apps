-- Migration: 20260724190000_fix_overlay_tenant_wide_hpp_mapping.sql
-- Enables tenant-wide HPP mapping resolution in overlay RPC so global SKU mappings match regardless of marketplace_account_id
