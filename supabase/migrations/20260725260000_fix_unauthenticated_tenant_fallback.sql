-- Migration: 20260725260000_fix_unauthenticated_tenant_fallback.sql
-- Ensures tenant_id resolution falls back to active marketplace orders tenant when auth.uid() is null (anon key calls)
...
begin
  ...
  v_res := jsonb_build_object(
    'ok', true,
    'source', 'finance_dashboard_snapshot_core_20260625_fixed_v5',
