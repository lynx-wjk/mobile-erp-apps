-- Migration: 20260725310000_fix_circular_rls_recursion.sql
-- Removes table self-query inside RLS policy to resolve circular recursion in _tenant_rpc_current_tenant_id
...
begin
  ...
  v_res := jsonb_build_object(
    'ok', true,
    'source', 'finance_dashboard_snapshot_core_20260625_fixed_v6',
