-- Migration: 20260725380000_speed_up_overlay_with_hash_joins.sql
-- Fixes Cartesian product in overlay_20260623 by replacing OR joins with 3 separate hash joins on hpp_sku, hpp_seller, and hpp_local.
