-- Migration: 20260724180000_fix_overlay_nullif_coalesce.sql
-- Fixes coalesce fallback logic in overlay RPC using nullif so zero payouts fall back properly to pre-calculated values
