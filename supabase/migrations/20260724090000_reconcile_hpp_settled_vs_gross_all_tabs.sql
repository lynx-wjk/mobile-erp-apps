-- Migration: 20260724090000_reconcile_hpp_settled_vs_gross_all_tabs.sql
-- Reconciles HPP calculations across Tab Ringkasan and Tab Marketplace
-- Ensures 100% 1-to-1 sync for Settled HPP, Sample HPP, Unpaid Est HPP, and Total All HPP
...
begin
  ...
  -- 1. Pre-aggregated HPP mappings CTEs
  with hpp_sku as (
  ...
  -- 2. Valid non-cancelled orders in selected date range
  valid_orders as (
    select
      o.tenant_id,
  ...
  -- 3. Inject reconciled metrics into v_summary
