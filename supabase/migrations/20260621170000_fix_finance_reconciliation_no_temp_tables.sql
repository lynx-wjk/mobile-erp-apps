-- Migration to eliminate temporary tables and DDL from public.finance_marketplace_reconciliation_breakdown
-- Enforces select-only CTE query structure so it can safely execute under read-only transactions.
