-- Migration: 20260725210000_fix_overlay_marketplace_distinct_metrics.sql
-- Fixes overlay RPC to produce 100% distinct marketplace metrics for Shopee vs TikTok Shop
...
begin
  ...
  mp_enriched as (
    select
      ...
      coalesce(nullif(h.settled_hpp, 0), nullif((r.elem->>'settled_hpp')::numeric, 0), 0)::numeric as settled_hpp_val,
