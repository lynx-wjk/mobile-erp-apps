-- Migration: 20260724140000_fix_overlay_tenant_id_fallback.sql
-- Fixes tenant_id resolution fallback in overlay RPC so HTTP requests never return null overlay
