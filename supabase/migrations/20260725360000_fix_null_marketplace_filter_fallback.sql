-- Migration: 20260725360000_fix_null_marketplace_filter_fallback.sql
-- Fixes NULL/empty p_marketplace parameter handling so all marketplaces are selected when p_marketplace is NULL or empty string.
...
begin
  ...
  v_res := jsonb_build_object(
    'ok', true,
    'source', 'finance_dashboard_snapshot_core_20260625_fixed_v7',
