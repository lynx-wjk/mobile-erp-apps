-- Fast dashboard + marketplace breakdown.
-- No per-order finance join, because REST timeout limit is too tight.
-- Fixes Shopee missing in Marketplace tab while keeping REST response fast.
...
begin
  ...
  return jsonb_build_object(
    'ok', true,
    'source', 'finance_dashboard_snapshot_fast_breakdown_no_join_20260624',
    'start', v_start,
    'end', v_end,
