-- Migration: 20260725280000_fix_overlay_tenant_resolution_fallback.sql
-- Fixes tenant resolution in overlay RPC so active tenant with orders is selected when auth.uid() is null
