-- Migration: 20260725390000_supercharge_finance_payout_index_scan.sql
-- Restricts finance_payout scanning to orders matching valid_orders to reduce query execution time to < 1.0 second.
