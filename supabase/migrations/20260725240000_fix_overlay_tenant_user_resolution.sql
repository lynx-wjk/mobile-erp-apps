-- Migration: 20260725240000_fix_overlay_tenant_user_resolution.sql
-- Fixes tenant resolution in overlay RPC so user_id from auth.uid() resolves tenant_id correctly.
