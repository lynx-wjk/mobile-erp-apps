-- Migration: Fix service_fee column missing from marketplace_finance_reports.
-- The marketplace_finance_reports table does NOT have a service_fee column
-- (only marketplace_finance_items does). Replace service_fee with 0 in the
-- fee aggregation CTE that queries marketplace_finance_reports.

-- 1. Patch finance_dashboard_snapshot_core_20260625
...
begin
  ...
  -- We use 0 for service_fee here; it will be sourced from marketplace_finance_items
