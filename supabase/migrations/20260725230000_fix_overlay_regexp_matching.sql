-- Migration: 20260725230000_fix_overlay_regexp_matching.sql
-- Fixes marketplace key normalization in overlay RPC so settled HPP joins accurately for Shopee and TikTok Shop
