-- Migration: 20260725430000_blazing_fast_tiny_ram_lookups.sql
-- Optimizes HPP lookup CTEs to build tiny RAM tables and speeds up marketplace_order_items joins to under 200ms.
