-- Migration: 20260725460000_drop_overloaded_sku_group_function.sql
-- Drops old overloaded function signatures for finance_sku_order_details_group_20260625 to prevent PostgREST HTTP 300 Multiple Choices errors.

DROP FUNCTION IF EXISTS public.finance_sku_order_details_group_20260625(date, date, text, uuid, text, text, integer, integer);
DROP FUNCTION IF EXISTS public.finance_sku_order_details_group_20260625(date, date, text, uuid, text, text, text, text, integer, integer);
