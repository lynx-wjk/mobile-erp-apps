-- Clean SQL fix for date filtering in finance_dashboard_snapshot_base_20260623 and wrapper
...
begin
  ...
  create temp table _tmp_finance_scoped on commit drop as
  select
    fr.*,
